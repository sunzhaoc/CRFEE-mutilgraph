        ...
        for i = 1:10
            ...
            for j = 1:min_dim
                ...
                for k = 0:graph_num
                    ...
                    load (['./Processed_dataset/', datasetname, '/03PCA/train/split', num2str(i), '/', num2str(graphchoose(:, k+1))])
                    load (['./Processed_dataset/', datasetname, '/05CRFEE_P2/train/split', num2str(i), '/', num2str(graphchoose(:, k+1))]);
